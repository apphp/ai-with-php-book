...
<div align="left"><figure><img src="../../.gitbook/assets/ai-turing-test-min.png" alt="" width="375"><figcaption><p>Turing Test in AI</p></figcaption></figure></div>
...
3. **SHRDLU (1970): Natural-language Understanding Computer Program**\
   ...
   Wiki: [https://en.wikipedia.org/wiki/SHRDLU](https://en.wikipedia.org/wiki/SHRDLU)
4. **Jabberwacky (1988): Emulating Human-Like Banter**\
...
5. **Eugene Goostman (2001): The “Young” Chatbot that Fooled Many**\
...
6. **Cleverbot (2008): A Chatbot That Learns from Experience**\
...
7. **Mitsuku (2013): The Award-Winning AI Companion**\
...
8. **GPT-3 (2020): A Leap in Conversational AI**\
...
9. **LaMDA (2021): Conversational AI with “Natural” Dialogue Flow**\
